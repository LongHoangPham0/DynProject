bluemoon.reactjs.staticFieldDefs = {
    ...
    appliedFields: {
        ...
        dataSourceApi: window.rootUrl + 'system/itemtype/properties',
    ...
    reporting_dataSource: {
        ...
        dataSourceApi: window.rootUrl + 'api/report/datasource',
        valueChangedFunc: function (s, n, o, c) {
    ...
    reporting_visibleColumns: {
        type: 'checkboxlist',
        dataField: 'colIds',
        dataSourceApi: window.rootUrl + 'api/item/properties',
        dataApiParamsFunc: function (s, url) {
            var view = s.getView();
    ...
    rule_item: {
        ...
        dataSourceApi: window.rootUrl + 'api/rule/itemType',
        valueChangedFunc: function (s, n, o, c) {
            var view = s.getView();
    ...
    sys_itemType: {
        type: 'dropdownlist',
        label: 'Item type',
        dataSourceApi: window.rootUrl + 'api/item/types',
    }
};