bluemoon.reactjs.staticViewDefs = {
    ...
    sys_anyItem_listView: {
        ...
        dataApi: window.rootUrl + 'api/item/list.json',
    ...
    sys_anyItem_approvalList: {
        ...
        dataApi: window.rootUrl + 'api/item/approvalList.json',
        dataApiParamsFunc: function (sender, url) {
            var opt = sender.props.options;
    ...
    sys_anyItem_submittedList: {
        ...
        dataApi: window.rootUrl + 'api/item/list/submitted.json',
        dataApiParamsFunc: function (sender, url) {
            var opt = sender.props.options;
            var val = window.storage.get(opt.listStorage);
            return { type: opt.itemName, searchFor: val ? val.searchValue : '', page: sender.pageIndex };
    ...
    sys_anyItem_approvedList: {
        ...
        dataApi: window.rootUrl + 'api/item/list/approved.json',
        dataApiParamsFunc: function (sender, url) {
            var opt = sender.props.options;
            var val = window.storage.get(opt.listStorage);
            return { type: opt.itemName, searchFor: val ? val.searchValue : '', page: sender.pageIndex };
    ...
    sys_anyItem_rejectedList: {
        ...
        dataApi: window.rootUrl + 'api/item/list/rejected.json',
        dataApiParamsFunc: function (sender, url) {
            var opt = sender.props.options;
            var val = window.storage.get(opt.listStorage);
            return { type: opt.itemName, searchFor: val ? val.searchValue : '', page: sender.pageIndex };
    ...
    sys_anyItem_sublistView: {
        ...
        dataApi: window.rootUrl + 'api/item/childList.json',
        dataApiParamsFunc: function (sender, url) {
            var opt = sender.props.options;
    ...
    sys_anyItem_sellistView: {
        ...
        dataApi: window.rootUrl + 'api/item/selectChildItems.json',
        dataApiParamsFunc: function (sender, url) {
            var opt = sender.props.options;
            return { parentID: opt.linkedItemId, type: opt.itemName, page: sender.pageIndex };
        },
        submitApi: window.rootUrl + 'api/item/addChildItems.json',
        submitApiParamsFunc: function (s, d) {
            var opt = s.props.options;
            d.parentID = opt.linkedItemId;
            return d;
        },
        deleteApi: window.rootUrl + 'api/item/removeChildItem.json',
    ...
    sys_anyItem_linkedView: {
        ...
        dataApi: window.rootUrl + 'api/item/getChildItems.json',
        dataApiParamsFunc: function (sender, url) {
    ...
    sys_item_history: {
        ...
        dataApi: window.rootUrl + 'api/history/list.json',
        dataApiParamsFunc: function (sender, url) {
    ...
    sys_item_comment_view: {
        ...
        dataApi: window.rootUrl + 'api/comment/list.json',
        dataApiParamsFunc: function (sender, url) {
            return { itemId: sender.props.options.itemId, page: sender.pageIndex };
        }
    },
    sys_item_comment: {
        ...
        submitApi: window.rootUrl + 'api/comment/add.json',
    ...
    sys_item_attachments: {
        ...
        dataApi: window.rootUrl + 'api/attachment/list.json',
        dataApiParamsFunc: function (sender, url) {
            return { itemId: sender.props.options.itemId, page: sender.pageIndex };
        }
    ...
    sys_attachment: {
        ...
        submitApi: window.rootUrl + 'api/attachment/upload.json',
        deleteApi: window.rootUrl + 'api/attachment/delete.json'
    },
    sys_validationDef: {
        fields: [
            {
    ...
    sys_reporting_view: {
        ...
        dataApi: window.rootUrl + 'api/report/data.json',
        dataApiParamsFunc: function (sender, url) {
    ...
    sys_reporting_detail: {
        ...
        dataApi: window.rootUrl + 'api/report/detail.json',
        dataApiParamsFunc: function (s, url) {
            return { reportId: s.props.options.reportId };
        },
        deleteApi: window.rootUrl + 'api/report/delete.json',
        deleteApiParamsFunc: function (s, d) {
            return { reportId: d.id };
        },
        submitApi: window.rootUrl + 'api/report/save.json',
        submitApiParamsFunc: function (s, d) {
    ...
    sys_reporting_result: {
        ...
        dataApi: window.rootUrl + 'api/report/preview.json',
        dataApiParamsFunc: function (sender, url) {
    ...
    sys_reporting_list: {
        ...
        dataApi: window.rootUrl + 'api/report/list.json',
        dataApiParamsFunc: function (sender, url) {
            var opt = sender.props.options;
            var val = window.storage.get(opt.listStorage);
    ...
    sys_item_approval: {
        ...
        submitApi: window.rootUrl + 'api/approval/submit.json',
        submitApiParamsFunc: function (s, d, m) {
            return { itemId: s.props.options.itemId, comment: d.content };
        },
        deleteApi: window.rootUrl + 'api/approval/reject.json',
    ...
    sys_item_approval_loader: {
        ...
        dataApi: window.rootUrl + 'api/approval/check.json',
    ...
    sys_rule_list: {
        ...
        dataApi: window.rootUrl + 'api/rule/list.json',
        dataApiParamsFunc: function (sender, url) {
            var opt = sender.props.options;
            var val = window.storage.get(opt.listStorage);
            return { searchFor: val ? val.searchValue : '', pageIndex: sender.pageIndex, t: new Date().getTime() };
    ...
    sys_rule_detail: {
        ...
        dataApi: window.rootUrl + 'api/rule/detail.json',
        dataApiParamsFunc: function (s, url) {
            return { ruleId: s.props.options.ruleId };
        },
        deleteApi: window.rootUrl + 'api/rule/delete.json',
        deleteApiParamsFunc: function (s, d) {
            return { ruleId: d.id };
        },
        submitApi: window.rootUrl + 'api/rule/save.json',
    ...
    sys_anyItem_selectionView: {
        ...
        dataApi: window.rootUrl + 'api/item/selectionList.json',
        dataApiParamsFunc: function (v, url) {
            var ctrl = v.find('sys_itemType');
            var type = ctrl.getValue();
            if (type == null) return { shouldCancel: true };
            else return { type };
        },
    }
};